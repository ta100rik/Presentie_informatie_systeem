...
public class Application {
	...
	public static void main(String[] args) {
		...
		LesController lesController = new LesController(infoSysteem);
...
//		MyRoosterController myroostercontroller = new MyRoosterController(infoSysteem);
...
//		server.registerHandler("/student/rooster", myroostercontroller);
        ...
        server.registerHandler("/les/ophalen", lesController);
